...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'bluetooth_permission_denied': 'Please grant "Nearby Devices" permission to view Bluetooth audio device information.',
      'bluetooth_permission_permanently_denied': '"Nearby Devices" permission was denied. Please enable it in Settings → Nearby Devices.',
    ...
    'zh_TW': {
      ...
      'bluetooth_permission_required': '需要「鄰近裝置」權限',
      'bluetooth_permission_denied': '請授予「鄰近裝置」權限以查看藍牙音訊裝置資訊。',
      'bluetooth_permission_permanently_denied': '「鄰近裝置」權限已被拒絕。請前往設定 → 鄰近裝置，開啟權限。',
